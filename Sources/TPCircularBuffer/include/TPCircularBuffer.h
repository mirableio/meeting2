...
//
//  Vendored with repository placement plus one local include for realtime-safe
//  counters. The recorder relies on it as the single-producer/single-consumer
//  handoff from Core Audio IOProc to writer.
//
